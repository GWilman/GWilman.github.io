        ...
        <div style={this.container} className="mobileContainer">
          <div id="mobileProjects">
            <div>
              ...
              <p style={this.pStyle}><i className="fa fa-laptop" aria-hidden="true"></i> <a href="https://vincegrid.herokuapp.com/" target="_blank" rel="noopener noreferrer">Visit Website</a></p>
            ...
            <div>
              ...
              <p style={this.pStyle}><i className="fa fa-laptop" aria-hidden="true"></i> <a href="https://ga-feedback-george.herokuapp.com/" target="_blank" rel="noopener noreferrer">Visit Website</a></p>
            ...
            <div>
              ...
              <p style={this.pStyle}><i className="fa fa-laptop" aria-hidden="true"></i> <a href="https://trax-share.herokuapp.com/" target="_blank" rel="noopener noreferrer">Visit Website</a></p>
            ...
            <div>
              ...
              <p style={this.pStyle}><i className="fa fa-laptop" aria-hidden="true"></i> <a href="https://wee-words.herokuapp.com/" target="_blank" rel="noopener noreferrer">Visit Website</a></p>
